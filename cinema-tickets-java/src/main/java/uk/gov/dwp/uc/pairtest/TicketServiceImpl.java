...
public class TicketServiceImpl implements TicketService {
    ...
    */
    ...
    NOTE: no of infants also considered for no of ticket calculation
    Returns True if above condition satisfied.
    By changing the access modifier to public we can do JUnit test by using TicketServiceTest class.
    */
    private  boolean isInAllowableLimitPerBooking(TicketTypeRequest... ticketTypeRequests) {
        var ticketCount = 0;
        for (TicketTypeRequest ticketTypeRequest : ticketTypeRequests) {
    ...
    */
    ...
    By changing the access modifier to public we can do JUnit test by using TicketServiceTest class.
    */
    private int totalSeatAllocation(TicketTypeRequest... ticketTypeRequests) {
        var noOfSeats = 0;
        for (TicketTypeRequest ticketTypeRequest : ticketTypeRequests) {
